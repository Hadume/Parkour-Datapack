...
## 当たり判定付きブロック
  execute positioned ~ ~ ~ run summon armor_stand ~ ~-0.7406250089406968 ~ {Invulnerable:1b,Silent:1b,Invisible:1b,NoBasePlate:1b,Pose:{Head:[180f,0f,0f]},Small:1b,Passengers:[{id:"shulker",Invulnerable:1b,NoGravity:1b,Silent:1b,NoAI:1b,ActiveEffects:[{Id:14,Amplifier:0b,Duration:-1,ShowParticles:0b}],Tags:["Area"]},{id:"block_display",block_state:{Name:"block"},Tags:["Init","Area"]}],Tags:["Area"]}
## BlockDisplay
  ### 
