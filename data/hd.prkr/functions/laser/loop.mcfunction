...
#   hd.prkr:5.tick
 ...
 #declare tag HdP.Hit
## パーティクルを出す
	particle dust 1 0 0 1.5 ~ ~ ~ 0 0 0 0 1
## 音を鳴らすためのTag
...
## ループ
	execute positioned ^ ^ ^1 if block ~ ~ ~ air positioned ^ ^ ^-10 unless entity @s[distance=..0.001] positioned ^ ^ ^10 run function hd.prkr:laser/loop
