...
## 看板にコマンドを代入
	data modify block ~ ~ ~ front_text.messages[-1] set value '{"block":"~ ~ ~","nbt":"front_text.messages[-1]","interpret":true,"clickEvent":{"action":"run_command","value":"/execute align xyz positioned ~0.5 ~ ~0.5 run function hd.prkr:egg/attractive.sign/action/"}}'
	data modify block ~ ~ ~ back_text.messages[-1] set value '{"block":"~ ~ ~","nbt":"back_text.messages[-1]","interpret":true,"clickEvent":{"action":"run_command","value":"/execute align xyz positioned ~0.5 ~ ~0.5 run function hd.prkr:egg/attractive.sign/action/"}}'
