...
## 手に卵を持っていたら
	execute if entity @s[gamemode=creative,scores={HdP.SneakTime=1}] if data storage hd.p: SelectedItemCopy.tag.HdP if entity @e[type=marker,tag=HdP,distance=..2] run function hd.prkr:egg/change/
